...
def get_spark_session(app_name="FastAPI_Spark_App"):
    ...
    return SparkSession.builder \
        ...
        .config("spark.executor.extraJavaOptions", "-Djava.library.path=C:\\Users\\danso\\winutils\h\adoop-3.0.1") \
        .config("spark.driver.extraJavaOptions", "-Djava.library.path=C:\\Users\\danso\\winutils\h\adoop-3.0.1\\bin") \
