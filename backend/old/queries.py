...
# Charger les données Parquet avec DuckDB
file_path = r"C:/Users/danso/Documents/Bigdata/FlightStatusPrediction/backend/data/Combined_Flights_2018.parquet"

# Créer une connexion à DuckDB
conn = duckdb.connect()

# Charger le fichier Parquet dans une table temporaire
conn.execute(f"CREATE TABLE flights AS SELECT * FROM '{file_path}'")
